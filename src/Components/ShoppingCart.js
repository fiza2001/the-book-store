    ...
    return (
            ...
            <div className="modal" style={{display: visibility ? "block" : "none"}}>
                ...
                <div className="cart-products">
                    {Data.length === 0 && (<span className="empty-text">Your cart is Empty</span>)}
                    {Data.map((datas) => (
                        ...
                        <select className="count" value={datas.count} onChange={(event) => {
                        ...
                        <button className="remove-btn" onClick={() => onProductRemove(datas)}>
